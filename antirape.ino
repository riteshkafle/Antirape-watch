...
String f1001 = "+9779817448555"; 
String f1002 = "+9779827494494"; 
String f1003 = "+9779827494493";
  ...
  lcd.print("     IN DANGER");  
       ...
       delay(250);
        ...
        delay(250);
               ...
               void sendcall()
{
  mySerial.println("ATD+9779817448555;"); // ATDxxxxxxxxxx; -- watch out here for semicolon at the end!!
